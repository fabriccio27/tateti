  ...
  render(){
    const winnerJSX = (
      <div>
        ...
        <button onClick={this.resetGame} className="reset-btn">Jugar de nuevo <FontAwesomeIcon icon={faSyncAlt}/></button>
      </div>
    );
    return(
      <div>
        ...
        <CurrentPlayer isPlayerOne={this.state.isPlayerOne}/>
        <div className="row">
